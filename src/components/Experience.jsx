  ...
  const experiences = [
    {
      ...
      company: "ESCON - Infra & Realtor",
      period: "2027 - Present",
      description:
        "Developing scalable backend infrastructure and microservices for real estate platform. Implementing RESTful APIs, database optimization, and system architecture to handle high-traffic scenarios.",
    },
    {
      icon: Network,
